...
if __name__ == "__main__":
    ...
    for query in queries:
        ...
        cutoff = bisect.bisect_left(startTimes,query[1])
        valuesToBeCalculatedA = logEntriesSortedByStart[:cutoff]
        # pprint(valuesToBeCalculatedA)

        #---------------------------------------------------
        #                                    |XXX|          |
        #---------------------------------------------------
        # else:
        cutoff = bisect.bisect_right(endTimes,query[0])
        # print "cutoff",cutoff
        # print "query[0]",query[0]
        # print endTimes
        valuesToBeCalculatedB = logEntriesSortedByEnd[cutoff:]
        # pprint(valuesToBeCalculatedB)
